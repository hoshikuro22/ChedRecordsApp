    ...
    <div className="fixed inset-0 flex items-center justify-center">
      ...
      <div className="bg-white rounded-lg p-8 z-50">
        ...
        <div className="flex flex-col items-center">
          <label htmlFor="First_Name" className="mb-1 text-sm font-semibold">First Name</label>
          <input
            type="text"
            id="First_Name"
            name="First_Name"
        ...
        <div className="flex flex-col">
          <label htmlFor="Last_Name" className="mb-1 text-sm font-semibold">Last Name</label>
          <input
            type="text"
            id="Last_Name"
            name="Last_Name"
        ...
        <div className="flex flex-col">
          <label htmlFor="Email" className="mb-1 text-sm font-semibold">Contact Number</label>
          <input
            type="text"
            id="Contact_Number"
            name="Contact_Number"
