...
import { BsFillPersonFill, BsPersonVcard, BsFillPersonLinesFill } from 'react-icons/bs';
        ...
        <div className=" bg-slate-800 text-white w-72 py-4 px-6">
          ...
          <div className="flex items-center mt-5">
            ...
            <div className="text-center block items-center mb-5">
              ...
              <div className="text-center block items-center mb-2">
                <li>
                  <a href="/admin/clienttypes" className="py-1 px-2 rounded hover:bg-gray-700 flex gap-3 items-center">
                    <BsFillPersonLinesFill />Client Types
                  </a>
                </li>
              </div>
